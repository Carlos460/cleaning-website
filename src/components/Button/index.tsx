export default function Button(props: {theme?: string, children: any}) {    
  return (
    ...
    <button className="bg-transparent shadow border-2 border-gray-200 hover:bg-blue-500 hover:-translate-y-1.5 transition duration-300 py-4 px-6 rounded-md [&>p]:hover:text-white">
